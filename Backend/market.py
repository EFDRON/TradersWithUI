...
alpca_api_key = os.getenv("ALPACA_API_KEY")
alpaca_secret_key = os.getenv("ALPACA_SECRET_KEY")

def is_market_open() -> bool:
    client = TradingClient(alpca_api_key, alpaca_secret_key, paper=True)
...
def get_share_price_alpaca(symbol) -> float:
    client = StockHistoricalDataClient(alpca_api_key, alpaca_secret_key)
...
def get_share_price(symbol) -> float:
    ...
    try:
        return get_share_price_alpaca(symbol)
