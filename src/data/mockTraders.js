export const TRADERS = [
  {
    ...
    description: 'Aggressive momentum-based strategy targeting high-velocity tech stocks',
    color: '#00d4ff',
    colorDim: 'rgba(0, 212, 255, 0.15)',
    colorRgb: '0, 212, 255',
    gradient: 'from-cyan-500/20 to-blue-600/20',
    initialBalance: 1247583.42,
    personality: 'aggressive',
    holdings: [
      { ticker: 'NVDA', shares: 450, avgPrice: 142.30, currentPrice: 158.75 },
      { ticker: 'TSLA', shares: 280, avgPrice: 285.50, currentPrice: 312.40 },
      { ticker: 'AMD', shares: 1200, avgPrice: 178.20, currentPrice: 195.80 },
      { ticker: 'META', shares: 320, avgPrice: 505.00, currentPrice: 542.15 },
      { ticker: 'MSFT', shares: 180, avgPrice: 445.60, currentPrice: 468.90 },
    ],
    cash: 89420.15,
    winRate: 0.73,
    totalTrades: 1847,
  ...
  },
  {
    ...
    name: 'ORACLE-X',
    role: 'Value Analyst',
    description: 'Deep fundamental analysis with long-term value investing approach',
    color: '#a855f7',
    ...
    holdings: [
      { ticker: 'BRK.B', shares: 800, avgPrice: 425.00, currentPrice: 448.30 },
      { ticker: 'JNJ', shares: 1500, avgPrice: 162.40, currentPrice: 171.85 },
      { ticker: 'PG', shares: 900, avgPrice: 168.90, currentPrice: 175.20 },
      { ticker: 'KO', shares: 2000, avgPrice: 61.50, currentPrice: 64.80 },
      { ticker: 'JPM', shares: 600, avgPrice: 198.75, currentPrice: 215.40 },
    ],
    cash: 312580.44,
    winRate: 0.81,
    totalTrades: 432,
  ...
  },
  {
    ...
    description: 'High-frequency cross-market arbitrage with microsecond execution',
    color: '#10b981',
    ...
    holdings: [
      { ticker: 'SPY', shares: 2000, avgPrice: 548.20, currentPrice: 556.40 },
      { ticker: 'QQQ', shares: 1500, avgPrice: 498.30, currentPrice: 512.70 },
      { ticker: 'IWM', shares: 3000, avgPrice: 212.40, currentPrice: 218.90 },
      { ticker: 'GLD', shares: 800, avgPrice: 235.60, currentPrice: 241.30 },
      { ticker: 'TLT', shares: 1200, avgPrice: 98.40, currentPrice: 101.20 },
    ],
    cash: 45230.88,
    winRate: 0.68,
    totalTrades: 12493,
  ...
  },
  {
    ...
    name: 'SENTINEL',
    role: 'Risk Manager',
    description: 'Portfolio protection with dynamic hedging and risk-adjusted allocation',
    color: '#f59e0b',
    ...
    holdings: [
      { ticker: 'VIX', shares: 5000, avgPrice: 14.20, currentPrice: 16.85 },
      { ticker: 'SH', shares: 3000, avgPrice: 13.80, currentPrice: 14.20 },
      { ticker: 'GOVT', shares: 4000, avgPrice: 24.60, currentPrice: 25.10 },
      { ticker: 'UUP', shares: 2500, avgPrice: 28.40, currentPrice: 28.95 },
      { ticker: 'SPLV', shares: 1800, avgPrice: 68.20, currentPrice: 70.45 },
    ],
    cash: 524180.22,
    winRate: 0.76,
    totalTrades: 892,
...
export const RECENT_TRADES_TEMPLATES = {
  'nexus-7': [
    { side: 'BUY', ticker: 'NVDA', shares: 150, price: 158.42, time: '14:32:18' },
    { side: 'SELL', ticker: 'META', shares: 80, price: 543.20, time: '14:28:05' },
    { side: 'BUY', ticker: 'AMD', shares: 200, price: 195.55, time: '13:45:33' },
    { side: 'SELL', ticker: 'TSLA', shares: 50, price: 313.80, time: '12:15:42' },
    { side: 'BUY', ticker: 'MSFT', shares: 100, price: 466.30, time: '11:22:17' },
    { side: 'BUY', ticker: 'NVDA', shares: 75, price: 155.80, time: '10:08:55' },
    { side: 'SELL', ticker: 'AMD', shares: 300, price: 192.40, time: '09:45:22' },
  ],
  'oracle-x': [
    { side: 'BUY', ticker: 'JNJ', shares: 200, price: 171.60, time: '13:15:08' },
    { side: 'BUY', ticker: 'KO', shares: 300, price: 64.55, time: '11:42:33' },
    { side: 'SELL', ticker: 'BRK.B', shares: 100, price: 449.20, time: '10:30:15' },
    { side: 'BUY', ticker: 'PG', shares: 150, price: 174.80, time: '09:55:42' },
    { side: 'BUY', ticker: 'JPM', shares: 100, price: 214.20, time: '09:32:18' },
  ],
  'phantom': [
    { side: 'BUY', ticker: 'SPY', shares: 500, price: 556.20, time: '14:45:02' },
    { side: 'SELL', ticker: 'IWM', shares: 750, price: 219.10, time: '14:45:02' },
    { side: 'SELL', ticker: 'SPY', shares: 500, price: 556.85, time: '14:47:15' },
    { side: 'BUY', ticker: 'IWM', shares: 750, price: 218.60, time: '14:47:15' },
    { side: 'BUY', ticker: 'QQQ', shares: 1000, price: 512.45, time: '13:22:48' },
    { side: 'SELL', ticker: 'QQQ', shares: 1000, price: 513.20, time: '13:23:01' },
    { side: 'SELL', ticker: 'GLD', shares: 800, price: 241.55, time: '12:05:33' },
    { side: 'BUY', ticker: 'GLD', shares: 800, price: 240.80, time: '11:58:42' },
  ],
  'sentinel': [
    { side: 'BUY', ticker: 'VIX', shares: 500, price: 16.42, time: '14:20:08' },
    { side: 'BUY', ticker: 'SH', shares: 1000, price: 14.18, time: '13:45:22' },
    { side: 'SELL', ticker: 'SPLV', shares: 200, price: 70.60, time: '12:30:15' },
    { side: 'BUY', ticker: 'GOVT', shares: 2000, price: 25.05, time: '11:15:42' },
    { side: 'BUY', ticker: 'UUP', shares: 500, price: 28.80, time: '10:22:08' },
  ],
};
