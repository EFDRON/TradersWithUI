...
# params = StdioServerParameters(command="python", args=[ "accounts_server.py"], env=None)
params = StdioServerParameters(command=sys.executable, args=["accounts_server.py"], env=None)
